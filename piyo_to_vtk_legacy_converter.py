...
class PiyoToVtkLegacyConverter(BaseVtkLegacyConverter):
    def ReadFile(self, in_file_name):
        with open('C:\\Users\\81805\\data\\Stanford_Bunny.fmt2', mode="r") as obj:
...
if __name__ == "__main__":
    ...
    in_obj_file = 'C:\\Users\\81805\\data\\Stanford_Bunny.fmt2'
    out_obj_file = 'C:\\Users\\81805\\data\\Stanford_Bunny.vtk'

    converter = PiyoToVtkLegacyConverter()
